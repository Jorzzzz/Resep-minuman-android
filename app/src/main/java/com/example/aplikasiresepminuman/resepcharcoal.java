...
public class resepcharcoal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resepcharcoal);

        ViewData("rspcharcoal");

        btn = (TextView) findViewById(R.id.btn);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                goLink("https://youtu.be/JGSNHfGBWGQ");
                goLink(link);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(resepcharcoal.this, daftarminuman.class);
