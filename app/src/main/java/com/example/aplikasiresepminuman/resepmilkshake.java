...
public class resepmilkshake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resepmilkshake);

        ViewData("rspmilkshake");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(resepmilkshake.this, daftarminuman.class);
